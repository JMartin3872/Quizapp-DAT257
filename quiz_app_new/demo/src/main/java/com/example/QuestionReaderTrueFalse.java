...
public class QuestionReaderTrueFalse implements QuestionReader {
    ...
    public LinkedList<Question> readQuestionFile(String fileName) {
      ...
      try {
          ...
          while (fileReader.hasNextLine()) {
              ...
              String wrongAnswer = fileReader.nextLine();
              String trivia = fileReader.nextLine();

              Question q = new QuestionTrueFalse(description, correctAnswer, wrongAnswer, trivia, id);
